...
#define WIFI_SSID "Phai0321"
#define WIFI_PASS "Phaipsc0321"
#define API_KEY "tCPMeB5Na2Wghok1lqi1nxXmEwGz1ugAofzfmiuENbqIqz3nVDrOw4WiNdHBpNEpjNQYpPTol7NnTaoPZscPbnjON9SDKlEptFLMwB0HiUIRO0MVSq7YlQWyTY3yzYuI
"
...
void send_sensor_data(float temperature, float humidity, bool switchStatus) {
    if (WiFi.status() == WL_CONNECTED) {
        ...
        String url = "http://192.168.208.91:3300/sensor-data";  // Ensure this IP is correct
